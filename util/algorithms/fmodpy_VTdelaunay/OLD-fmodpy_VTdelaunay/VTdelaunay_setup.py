...
# LINK_FILES = ["VTdelaunay.o","VTdelaunay_wrapper.o"]
# LINK_FILES = [f for f in os.listdir("/Users/thomaslux/Dropbox/Sync/bin/util/algorithms/fmodpy_VTdelaunay") if (f[-2:] == ".o")]
LINK_FILES = [f for f in os.listdir() if (f[-2:] == ".o")]
MODULE_NAME = "VTdelaunay"
CYTHON_SOURCE = ["VTdelaunay.pyx"]
